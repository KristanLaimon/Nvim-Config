...
$req = [System.Net.HttpWebRequest]::Create(']=] .. target_url:gsub("'", "''") .. [=[')
...
]], vim.json.encode(headers), vim.json.encode(body or ""), target_url, method:upper(), math.floor((timeout_ms or 15000) / 1000))
