...
M.settings = {
	...
	exact_layout = {
		...
		"box-border", "box-content", "grow", "shrink",
	},
	...
	layout_prefixes = {
		...
		"^flex%-", "^basis%-", "^grid%-", "^col%-", "^row%-",
		"^auto%-cols%-", "^auto%-rows%-", "^grid%-flow%-",
		"^items%-", "^justify%-", "^place%-items%-", "^place%-content%-",
		"^place%-self%-", "^self%-", "^gap%-", "^space%-x%-", "^space%-y%-",
		"^order%-", "^grow%-", "^shrink%-",
		"^w%-", "^min%-w%-", "^max%-w%-", "^h%-", "^min%-h%-", "^max%-h%-", "^size%-",
		"^overflow%-", "^overflow%-x%-", "^overflow%-y%-",
		"^float%-", "^clear%-", "^object%-", "^aspect%-",
	},
