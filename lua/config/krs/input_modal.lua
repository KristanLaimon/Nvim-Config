-- ============================================================================
-- 🦊 KRS CONFIG: Reusable Floating Input / Rename Modal Box
-- ============================================================================
...
function M.open(opts)
	...
	-- Clean up prompt string if passed from vim.ui.input (e.g. remove trailing colon)
	...
	vim.keymap.set({ "n", "i" }, "<Esc>", cancel, kopts)
