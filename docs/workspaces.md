...
- **Dashboard Return**: `<C-S-m>` allows closing the current workspace and returning cleanly to the Main Menu (Alpha Dashboard).
...
- `<C-S-m>`: Close session and return to Dashboard
