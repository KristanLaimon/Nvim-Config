...
| :--- | :--- | :--- |
| **Language Server (LSP)** | `vtsls`, `eslint`, `biome` | Fast TypeScript/JavaScript language server with auto-imports and inlay hints |
...
* `:LanguageManager` – Install or uninstall the TypeScript / JavaScript bundle.
